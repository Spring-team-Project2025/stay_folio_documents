...
import "../../styles/Diagram/UMLDiagramViewport.css";
import UMLDiagrams from "./UMLDiagrams";

// Figma-like pan/zoom viewport for UML diagrams
function UMLDiagramViewport({ tab }) {
...
export default UMLDiagramViewport;
